...
class BinaryReader {
    ...
    ensureAvailable(n) {
        if (this.remaining < n) {
            throw new Error(`Unexpected end of data at offset ${this.offset}: need ${n} bytes, have ${this.remaining}`);
        }
    }
    readUint16() {
 ...
 */
export function parsePhase2(data) {
...
function fp2AddLocal(a, b) {
    return {
        c0: (a.c0 + b.c0) % FP_MODULUS,
        c1: (a.c1 + b.c1) % FP_MODULUS,
    };
}
function fp2MulLocal(a, b) {
