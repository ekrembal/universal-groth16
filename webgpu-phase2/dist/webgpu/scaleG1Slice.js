 ...
 */
export function scaleG1SliceCPU(points, scalar) {
 ...
 */
function packPointsToU32(points) {
 ...
 */
function unpackU32ToPoints(limbs, n) {
 ...
 */
export async function scaleG1SliceGPU(device, points, scalar) {
    ...
    for (let offset = 0; offset < numPoints; offset += batchSize) {
        ...
        const resultU32 = await gpuBatchScalarMul(device, affineU32, scalarU32, count);
 ...
 */
export async function scaleG1SliceBatched(points, scalar, device) {
    if (device) {
        try {
...
//# sourceMappingURL=scaleG1Slice.js.map